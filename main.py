...
comida = pygame.image.load("./imagens/pixil-frame-0 (2).png")
raio = pygame.transform.scale(pygame.image.load("./imagens/raio.png"), (30, 30))
tamanho_quadrado = 25
...
def gerar_boost():
    posicao_x_boost = round(random.randrange(40, largura-tamanho_quadrado+15) / float(tamanho_quadrado)) * float(tamanho_quadrado)
    posicao_y_boost = round(random.randrange(40, altura-tamanho_quadrado+15) / float(tamanho_quadrado)) * float(tamanho_quadrado)
...
def rodar_jogo():
    ...
    while not fim_jogo:
        ...
        #desenhar boost
        if boost % 3 == 0:
            desenhar_boost(raio, posicao_x_boost, posicao_y_boost)
